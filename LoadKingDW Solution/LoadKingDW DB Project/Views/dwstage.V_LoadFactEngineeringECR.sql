CREATE VIEW [dwstage].[V_LoadFactEngineeringECR] 
AS
...
SELECT    
      ...
      ,[EMAIL_SENT]
		...
		+   cast([ORIG_DRAWNBY]			AS nvarchar(8))
		+   cast([ORIG_CHECKBY]			AS nvarchar(8))
		+   cast([ORIG_MODELBY]			AS nvarchar(8))
	 )
																		
-- select count(*)
FROM [dwstage].[GCG_5398_ECR] ECR
GO
