CREATE TABLE [dbo].[_V_QUOTE](
	...
	[QH_DATE_LAST_CHG] [datetime] NULL,
	[QH_DATE_DUE] [datetime] NULL,
	[QH_DATE_QUOTE_CNV] [datetime] NULL,
	[QH_DATE_DUE_CNV] [datetime] NULL,
	[QH_QTE_CREATED_DATE] [datetime] NULL,
	[QH_QUOTE_WON_LOSS_DATE] [datetime] NULL,
	[QH_MUST_DLVR_BY_DATE] [datetime] NULL,
	...
	[QL_DATE_SHIP] [datetime] NULL,
	[QL_DATE_QUOTE] [datetime] NULL,
	[QL_DATE_ITEM_PROM] [datetime] NULL,
	[QL_ITEM_PROMISE_DT] [datetime] NULL,
	[QL_DATE_LAST_INVOICE] [datetime] NULL,
	[QL_DATE_LAST_CHG] [datetime] NULL,
	[QL_QTY_QUOTED] [numeric](13, 4) NULL,
	[QL_QTY_SHIPPED] [numeric](13, 4) NULL,
	[QL_QTY_BO] [numeric](13, 4) NULL,
	[QL_WEIGHT] [numeric](10, 3) NULL,
	[QL_PRICE] [numeric](16, 6) NULL,
	[QL_COST] [numeric](16, 6) NULL,
	[QL_DISCOUNT] [numeric](5, 4) NULL,
	[QL_QTY_ORIGINAL] [numeric](13, 4) NULL,
	[QL_EXTENSION] [numeric](16, 2) NULL,
	[QL_MARGIN] [numeric](7, 4) NULL,
	[QL_DISCOUNT_PRICE] [numeric](16, 6) NULL,
