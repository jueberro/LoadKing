...
CREATE PROCEDURE dbo.getQUAL_DISP_U3
...
-- update x set MasterRunFlag = 'Y' from [LK-GS-CNC].dbo._TableList x where Table_Name = 'QUAL_DISP_U3'
...
BEGIN TRY
 ...
 Update [LK-GS-CNC].dbo._Tablelist  -- Rev4 c.
	...
	from [LK-GS-CNC].dbo._TableList Where Table_Name = @TblName -- 'QUAL_DISP_U3' -- @TblName
