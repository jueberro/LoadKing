...
CREATE PROCEDURE dbo.getQUALITY_SERIAL
...
-- update x set MasterRunFlag = 'Y' from [LK-GS-CNC].dbo._TableList x where Table_Name = 'QUALITY_SERIAL'
...
BEGIN TRY
 ...
 Update [LK-GS-CNC].dbo._Tablelist  -- Rev4 c.
	...
	from [LK-GS-CNC].dbo._TableList Where Table_Name = @TblName -- 'QUALITY_SERIAL' -- @TblName
