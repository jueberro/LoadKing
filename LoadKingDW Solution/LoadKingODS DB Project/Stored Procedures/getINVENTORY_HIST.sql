...
CREATE PROCEDURE dbo.getINVENTORY_HIST
...
SELECT 
@SourceTableName = 'INVENTORY_HIST'
,@LoadLogKey = 0
,@StartDate = '1/1/1900'
,@EndDate = getdate() 	
*/
...
-- update x set MasterRunFlag = 'Y' from [LK-GS-CNC].dbo._TableList x where Table_Name = 'INVENTORY_HIST'
...
BEGIN TRY
 ...
 Update [LK-GS-CNC].dbo._Tablelist  -- Rev4 c.
	...
	from [LK-GS-CNC].dbo._TableList Where Table_Name = @TblName -- 'INVENTORY_HIST' -- @TblName
