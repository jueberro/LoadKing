...
CREATE PROCEDURE dbo.getQUALITY_ADDL
...
-- update x set MasterRunFlag = 'Y' from [LK-GS-CNC].dbo._TableList x where Table_Name = 'QUALITY_ADDL'
...
BEGIN TRY
 ...
 Update [LK-GS-CNC].dbo._Tablelist  -- Rev4 c.
	...
	from [LK-GS-CNC].dbo._TableList Where Table_Name = @TblName -- 'QUALITY_ADDL' -- @TblName
